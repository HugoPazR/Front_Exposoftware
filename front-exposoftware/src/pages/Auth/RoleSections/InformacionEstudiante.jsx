    ...
    <>
      ...
      <div className="col-span-2">
        ...
        <div className="relative">
          <input
            name="correo" type="email" value={formData.correo} onChange={handleChange} disabled={cargando} placeholder="usuario@unicesar.edu.co"
            className={getInputClassName("correo")}
          />
          {successFields.correo && !errors.correo && (<CheckCircle className="absolute right-3 top-3 text-green-500" size={20} />)}
        </div>
