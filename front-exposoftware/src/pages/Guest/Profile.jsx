                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full border border-gray-200 rounded-lg px-3 py-2 bg-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input 
                        type="email" 
                        defaultValue="andreslo@example.com" 
                        className="w-full border border-gray-200 rounded-lg px-3 py-2 bg-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                      />
                    </div>
