...
export default function GuestDashboard() {
  ...
  const invitadoData = {
    // Atributos propios de Invitado (simulados por ahora)
    id_invitado: "INV-2025-001",
    id_usuario: user?.id || "USR-2025-456",
    ...
    direccion_residencia: user?.direccion_residencia || "No especificada",
    ciudad_residencia: user?.ciudad_residencia || "Valledupar",
    departamento_residencia: user?.departamento_residencia || "Cesar",
